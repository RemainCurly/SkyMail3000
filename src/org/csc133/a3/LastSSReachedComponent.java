...
public class LastSSReachedComponent extends Component
{
    private GameWorld g;
    ...
    /**
     * Gets our GameWorld, initializes the 7-segment displays, begins showing all 0's, and sets default LED color
     * @param gw The active instance of GameWorld
     */
    public LastSSReachedComponent(GameWorld gw)
    {
        g = gw;
    ...
    /**
     * Visually displays the Player helicopter's last skyscraper reached
     */
    private void setLastSSReached()
    {
        int lastSS = g.getGoc().getHeli().getLastSkyScraperReached();

        show[0] = digits[lastSS%10];
    }
