...
public class Helicopter extends Movable implements ISteerable
{
    ...
    * @param size      The determined Player helicopter size. Will ALWAYS equal Skyscraper's size
    */
    ...
    * @param containerOrigin   Origins of the CN1 container
    */
    ...
    * @param amount    Determines tilt amount of the stickAngle
    */
    ...
    * @param damage     Damage factor to alter speed/color
    */
   ...
   @Override
   /**
    * Alters heading based on stickAngle, one clock tick at a time.
    * Heading has constraints of 0-359
    * After heading changes, follows traditional move() method
    */
